...
(function(){
  ...
  var MOBILE = false;
  var LISTTARGET = '';     // blanket row target for pure list pages ('amm-pool'|'dex-asset'|'')
  var CONTAINERNAV = false;    // allow container-signal row nav (dex/amm/home)
  var LANDING = true;              // landing 'Pick a product' wiring
  ...
  function nav(base){ try{var P=window.parent; if(!P||P===window||!P.lxNavigate) return; P.lxNavigate(cand(base)); }catch(e){} }
