...
(function(){
  ...
  var NETS={
    stellar:{ label:'Aptos', chip:'Aptos', addr:'0x0e23…b7ac', sub:'Choose a wallet to continue', groups:[
    ...
    xrpl:{ label:'aBTC', chip:'aBTC', addr:'0x0193…fe04', sub:'Choose a Stellar wallet to continue', groups:[
      {section:'Popular', wallets:[
