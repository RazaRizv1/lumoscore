...
(function() {
  ...
  ready(function() {
    ...
    var allTrustlines = [
      { code:'USDC',  issuer:'Circle',          addr:'0x026e…16af', col:'linear-gradient(135deg,#2775ca,#1a5491)', ic:'U' },
      { code:'CELL',  issuer:'Cellana',        addr:'0x01d4…d14a', col:'linear-gradient(135deg,#22d3ee,#0891b2)', ic:'A' },
      { code:'LUMOS', issuer:'LumosCore',       addr:'0x0a60…5882', col:'linear-gradient(135deg,#ea6a2c,#ff9a3d)', ic:'L' },
      { code:'GUI',  issuer:'Gui Inu',    addr:'0x0ac8…9cd1', col:'linear-gradient(135deg,#35c07f,#16a34a)', ic:'K' },
      { code:'EURC', issuer:'Schuman Finance', addr:'0x0997…cd89', col:'linear-gradient(135deg,#fbbf24,#d97706)', ic:'E' },
      { code:'USDC', issuer:'Ripple',          addr:'0x0641…6bef', col:'linear-gradient(135deg,#6f5ded,#1e40af)', ic:'R' },
      { code:'WBTC', issuer:'Wrapped Bitcoin',         addr:'0x04ba…6e1a', col:'linear-gradient(135deg,#f43f5e,#9f1239)', ic:'P' },
      { code:'RION',  issuer:'Hyperion',         addr:'0x002d…a187', col:'linear-gradient(135deg,#10b981,#047857)', ic:'G' },
      { code:'MOD',  issuer:'Move Dollar',    addr:'0x0e96…6ece', col:'linear-gradient(135deg,#a855f7,#6d28d9)', ic:'N' },
      { code:'XDC',   issuer:'XDC Network',     addr:'0x0661…5d31', col:'linear-gradient(135deg,#06b6d4,#0e7490)', ic:'X' },
    ];
