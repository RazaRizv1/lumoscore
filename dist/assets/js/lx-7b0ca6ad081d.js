...
(function() {
  ...
  ready(function() {
    ...
    var allAssets = [
      ...
      { chain:'stellar', tk:'KALE',   nm:'Kale Finance',  ic:'K', col:'linear-gradient(135deg,#35c07f,#16a34a)', priceUsd:'$0.0074',   c24:'+12.4' },
      { chain:'stellar', tk:'NOVA',   nm:'Nova Capital',  ic:'N', col:'linear-gradient(135deg,#a855f7,#6d28d9)', priceUsd:'$0.00002',  c24:'+184',  isNew:true },
      { chain:'stellar', tk:'APT',    nm:'Aptos Coin',ic:'X', col:'#000000', priceUsd:'$0.4128',   c24:'+2.34' },
      { chain:'stellar', tk:'GLOW',   nm:'GlowDAO',       ic:'G', col:'linear-gradient(135deg,#10b981,#047857)', priceUsd:'$0.0099',   c24:'+15.7' },
      ...
      { chain:'xrpl',    tk:'CSC',    nm:'Casino Coin',   ic:'C', col:'linear-gradient(135deg,#35c07f,#16a34a)', priceUsd:'$0.0021',   c24:'+18.2' },
      { chain:'xrpl',    tk:'ELS',    nm:'Elysian',       ic:'E', col:'linear-gradient(135deg,#f43f5e,#be123c)', priceUsd:'$0.0024',   c24:'+9.1' }
    ];
