...
(function(){
  ...
  var NETS={
    stellar:{ label:'Aptos', chip:'Aptos', addr:'0x0fc8…9ccf', sub:'Choose a wallet to continue', groups:[
    ...
    xrpl:{ label:'XRP', chip:'XRP', addr:'0x04a7…34d0', sub:'Choose an XRPL wallet to continue', groups:[
      {section:'Popular', wallets:[
