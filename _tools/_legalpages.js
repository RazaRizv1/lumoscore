...
const STYLE = '<style id="lx-legal-css">'
  ...
  + '.lxsup-grid{display:grid;grid-template-columns:minmax(0,1fr) 290px;gap:22px;align-items:start}'
  ...
  + '.lxsup-aside{display:flex;flex-direction:column;gap:14px}'
  ...
  + '.lxsup-links a{display:flex;align-items:baseline;gap:7px;font-size:13.5px;color:var(--text);'
  + 'text-decoration:none;line-height:1.45}'
  + '.lxsup-links a:hover{color:var(--accent,#ea6a2c)}'
  + '.lxsup-links span{color:var(--text-muted,#8a8fa3);font-size:12.5px}'
...
const SUPPORT = '<div class="lxlg lxlg-sup">'
  ...
  + 'placeholder="A one-line summary"></div>'
  ...
  + '<li><a href="/trade/stellar#faq">Fees, curated listings and LUMOS <span>Trade</span></a></li>'
  + '<li><a href="/bridge#faq">Bridging USDC and claiming it <span>Cross-chain</span></a></li>'
  + '<li><a href="/wallet#faq">Trustlines and claimable payments <span>Wallet</span></a></li>'
  + '<li><a href="/pools/stellar#faq">Liquidity pools and their risks <span>Pools</span></a></li>'
  + '</ul></div>'
