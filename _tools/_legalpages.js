...
const STYLE = '<style id="lx-legal-css">'
  ...
  + '.lxsup-links a{display:flex;justify-content:space-between;align-items:baseline;gap:12px;'
  + 'font-size:13.5px;color:var(--text);text-decoration:none;line-height:1.45}'
  + '.lxsup-links a:hover{color:var(--accent,#ea6a2c)}'
  + '.lxsup-links span{flex:0 0 auto;white-space:nowrap;color:var(--text-muted,#8a8fa3);'
  + 'font-size:12.5px}'
