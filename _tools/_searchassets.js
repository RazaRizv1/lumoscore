...
const SCRIPT = `<script id="lx-searchassets">(function(){
  ...
  function poolRow(id){
    var ico='<div class="sp-ico lx-spico-on lx-poolico" data-pool="'+esc(id)+'" style="position:relative;overflow:visible;background:none;display:flex;align-items:center">'
