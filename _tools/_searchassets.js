...
.lx-poolico .lx-pi{width:24px;height:24px;flex:0 0 24px;border-radius:50%;display:block;position:relative;border:2px solid var(--surface,#131317);background-color:var(--surface-2);background-size:cover;background-position:center;background-repeat:no-repeat}
