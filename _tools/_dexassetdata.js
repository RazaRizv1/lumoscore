...
const SCRIPT = `<script id="lx-dxadata">(function(){
  ...
  function setRecvUsd(usdv){ var rf=recvEl(); if(!rf)return;
    ...
    var t=usdv>0?("\\u2248 $"+(usdv>=1?usdv.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}):usdv.toFixed(4))+" USD"):"\\u2248 $0.00 USD";
  ...
  function setPayUsd(usdv){ var pf=payFieldEl(); if(!pf)return; var row=pf.querySelector(".dxa-trade-frow"); if(!row)return;
    ...
    var t="\\u2248 $"+(usdv>=1?usdv.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}):usdv.toFixed(4))+" USD";
