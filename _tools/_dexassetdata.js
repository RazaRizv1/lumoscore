  ...
  function dxQuote(){
    ...
    _dxTmr=setTimeout(function(){
      ...
      Promise.all([
        ...
        if(!useSoro){ dxSpotRate(pa,ra,function(sr){ if(seq!==_dxSeq||!(sr>0)||!_dxView||_dxView.soro)return; var mag=dxImpMag(effRate/sr,ra); _dxView.impact=dxImpTxt(mag,ra); _dxView.impUp=dxImpUp(mag,ra); reAssertView(); }); }
      }).catch(function(){});
    },260);
  }
