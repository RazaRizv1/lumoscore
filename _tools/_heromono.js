...
.lumos-promo.lm-on .lm::before,.lumos-promo.lx-mobhero .lm::before{
  background:repeating-linear-gradient(0deg,rgba(255,255,255,0) 0px,rgba(255,255,255,0) 43px,rgba(255,255,255,.062) 43px,rgba(255,255,255,.062) 44px)!important;
  opacity:1!important}
html[data-theme="light"] .lumos-promo.lm-on .lm::before,html[data-theme="light"] .lumos-promo.lx-mobhero .lm::before{
  background:repeating-linear-gradient(0deg,rgba(16,16,22,0) 0px,rgba(16,16,22,0) 43px,rgba(16,16,22,.10) 43px,rgba(16,16,22,.10) 44px)!important;
  opacity:1!important}
