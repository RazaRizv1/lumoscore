...
.lx-boot-mark{width:60px;height:60px;background-size:contain;background-repeat:no-repeat;
...
@media (prefers-reduced-motion:reduce){.lx-boot-mark{animation:none}
...
const SCRIPT = `<script id="lx-ammdata">(function(){
  ...
  function bootShow(){
    ...
    el.innerHTML='<div class="lx-boot-in">'
      +'<div class="lx-boot-mark" data-logo="" data-logoed="1"'+((mk&&mk!=="none")?(' style="background-image:'+mk+'"'):'')+'></div>'
  ...
  (function(){
    ...
    bootArmed=true;
    setTimeout(function(){ try{ bootShow(); bootProgress(); }catch(_){} },400);
  })();
  function netFetch(){
