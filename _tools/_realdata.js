...
+'.activity-feed-row .act-ic{width:34px!important;height:34px!important;border-radius:11px}'
...
+'/* item 7: a row whose codes carry their own marks does not also need one at its left edge. */'
+'.activity-feed-row:has(.act-inl) .act-ic{display:none!important}'
...
+'"Accounts":["#2dd4bf",\'<circle cx="12" cy="9" r="3.2"/><path d="M5.5 19a6.5 6.5 0 0 1 13 0"/>\']};'
...
+'+(r.inl?"":(r.acode?(\'<div class="act-ic lx-actasset" data-lxc="\'+esc(r.acode)+\'" data-c="\'+esc(r.acode)+\'" data-i="\'+esc(r.aiss||"")+\'" data-l="\'+esc(String(r.acode).slice(0,2))+\'"></div>\')'
