...
+'.activity-feed-row .act-ic{width:40px!important;height:40px!important;border-radius:13px;box-shadow:inset 0 0 0 1px rgba(127,127,140,.20),0 1px 3px rgba(0,0,0,.10)}'
