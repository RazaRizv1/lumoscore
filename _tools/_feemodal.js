...
+'.lx-rv-buy{color:inherit;text-decoration:none;border-bottom:1px solid currentColor;opacity:.95}'
+'.lx-rv-buy:hover{opacity:1}'
...
+FM_BANNER_CSS+'.lx-feebanner-wrap{margin-top:10px}'
+'.lx-fee-lumos{color:var(--accent,#ea6a2c);font-weight:400;text-decoration:none;border-bottom:1px solid rgba(234,106,44,.35)}'
+'.lx-fee-lumos:hover{border-bottom-color:var(--accent,#ea6a2c)}'
// If the painter still lands on it, refuse the chip look: no fill, no radius, no forced size.
+'.lx-fee-lumos{background:none!important;background-image:none!important;border-radius:0!important;'
+'width:auto!important;height:auto!important;min-width:0!important;display:inline!important;'
+'box-shadow:none!important;padding:0!important;font-size:inherit!important;color:var(--accent,#ea6a2c)!important}'
+'.lx-fee-lumos svg{width:0!important;height:0!important;position:absolute!important}'
+'</style>';
...
+'+\'<div class="lx-rv-lumos-main"><div class="lx-rv-lumos-txt">Hold <b>250,000 <a class="lx-rv-buy" href="/lumos/stellar">LUMOS</a></b> to lower your fee to <b>0.1%</b></div>\''
+'+\'\''
+'+\'</div>\''
+'+\'</div></div>\''
...
+'var _buy=modal.querySelector(".lx-rv-buy");'
+'if(_buy)_buy.onclick=function(e){e.preventDefault();close();if(window.__lxNav)__lxNav(URL);else location.href=URL;};'
...
+'sum.appendChild(row);'
  ...
  +':\'<div class="lx-fee-banner nudge"><span class="lx-fee-ic"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 23c-4 0-7-2.7-7-6.5 0-2.3 1.2-4 2.4-5.4.3.9 1 1.6 1.9 1.6 1.4 0 1.7-1 1.6-3.5-.1-2.4 1-4.6 3.1-6.2-.4 2 .3 3.2 1.6 4.6C19 9.6 19 11.8 19 16.5c0 3.8-3 6.5-7 6.5z"></path></svg></span><span class="txt"><b>50% off trading fees</b> \\u2014 hold 250,000 <a class="lx-fee-lumos" href="lumoscore-lumos-token.html" data-lxc="" data-logoed="1"><svg width="0" height="0" aria-hidden="true" style="position:absolute;width:0;height:0;overflow:hidden"></svg>LUMOS</a></span></div>\';'
