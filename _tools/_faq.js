...
const BRIDGE_TWO_ROUTES = [
  ...
  ["Which chains are supported?", "Thirty-one destinations. CCTP carries USDC to Ethereum, Base, Arbitrum, Optimism, Polygon, Avalanche, Linea, World Chain, Sonic, Cronos, XDC, Plume, Codex, Pharos, Unichain, Morph and X Layer. LayerZero carries USDT0 to Ethereum, Arbitrum, Optimism, Polygon, Berachain, Ink, Hyperliquid, Monad, Flare, Sei, MegaETH, Plasma, Unichain, Mantle, Morph, X Layer, Hedera, Conflux eSpace, Rootstock, Stable and Tempo. Four chains take either route, and you choose which one to use."],
