...
const BRIDGE_TWO_ROUTES = [
  ...
  ["What are LayerZero and USDT0?", "LayerZero is a cross-chain messaging protocol, and USDT0 is Tether’s omnichain dollar built on it, live on Stellar since September 2026. The route burns USDT0 here and mints it on the destination, so what lands is real USDT0 rather than a wrapped copy — and it reaches seventeen chains CCTP cannot."],
  ["Which chains are supported?", "Twenty-five destinations. CCTP carries USDC to Ethereum, Base, Arbitrum, Optimism, Polygon, Avalanche, Linea and World Chain. LayerZero carries USDT0 to Ethereum, Arbitrum, Optimism, Polygon, Berachain, Ink, Hyperliquid, Monad, Flare, Sei, MegaETH, Plasma, Unichain, Mantle, Morph, X Layer, Hedera, Conflux eSpace, Rootstock, Stable and Tempo. Four chains take either route, and you choose which one to use."],
