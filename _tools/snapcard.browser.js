...
(function () {
  ...
  function render(m, img, flame, portrait) {
    ...
    var qrBox = big ? 132 : 100; // landscape is re-derived below, once the x-axis line is known
    var winH = big ? 106 : 100;
    var footH = big ? (qrBox + stampGap + stampLine) : 0;
    ...
    if (big) {
      ...
      drawStamp(qx, footTop + qrBox + stampGap);
    } else {
