...
.lx-mobhero .mdx-hero-ctas{display:grid!important;grid-template-columns:1.18fr .82fr;gap:9px;width:100%;margin:12px 0 0!important;padding:0!important;position:relative;z-index:3}
...
.lumos-promo .lm-h{font-size:18px!important;line-height:1.18!important;max-width:calc(100% - 96px)!important}
...
const SCRIPT = `<script id="lx-dexmain">(function(){
  ...
  function applyMobileHero(){
    ...
    lm.innerHTML='<div class="lm-chip"><div class="p1">XLM</div><div class="p2">\\u2014</div><div class="p3"></div></div>'
      +'<div class="lm-c"><h2 class="lm-h">'+head+'</h2>'
  ...
  function loadData(){
    ...
    batchPx(ASSETS).then(function(){ window.__lxDEXloaded=1; try{window.__lxDEXassets=ASSETS;window.__lxDEXmovers=moverData;window.__lxDEXlogoCss=logoCss;window.__lxDEXpriceRows=priceVisible;window.__lxDEXmints=mintList;}catch(_){} touch(); deferExtras(ASSETS); },
