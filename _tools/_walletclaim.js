...
.lx-wcico::after{content:attr(data-l);position:absolute;inset:0;display:flex;align-items:center;
  justify-content:center;color:#fff;font:800 13px/1 inherit;pointer-events:none}
...
.lx-wcamt .a{font:800 14px/1.25 'JetBrains Mono',monospace;color:var(--text)}
.lx-wcamt .u{font:600 11.5px/1.25 inherit;color:var(--text-soft)}
.lx-wcsub{margin-top:2px;font:600 11.5px/1.35 inherit;color:var(--text-soft);
