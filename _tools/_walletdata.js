...
+'out+=\'<tr><td><div class="asset-id"><div class="ico lx-aico" style="--ic:\'+icv+\'" data-l="\'+((isX||_slg)?"":esc(c.slice(0,1)))+\'" data-lxc="\'+(isX?"":esc(c))+\'" data-lxi="\'+(isX?"":esc(b.asset_issuer||""))+\'"></div><div class="meta"><div class="nm">\'+esc(c)+\'</div><div class="sb">\'+(isX?"Stellar \\u00b7 native":"Stellar asset")+\'</div></div></div></td>\''
...
+'+\'<td class="right">\'+_act+\'</td></tr>\';});if(out){tb.innerHTML=out;applyPins();lxLoadChanges(rows);try{lxHealAllLogos(tb);}catch(_){}}'
