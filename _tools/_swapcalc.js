...
+'.lxo-o{background:var(--bg);border:1px solid var(--border);border-radius:14px;padding:14px;margin-bottom:10px;transition:border-color .14s ease}'
+'.lxo-o:hover{border-color:var(--text-muted)}'
+'.lxo-top{display:block}'
+'.lxo-col{min-width:0}'
+'.lxo-cap{font-size:10.5px;font-weight:800;letter-spacing:.08em;text-transform:uppercase;color:var(--text-muted);margin:0 0 6px 1px}'
+'.lxo-side{display:flex;align-items:center;gap:11px;min-width:0}'
+'.lxo-tx{min-width:0;display:flex;align-items:baseline;gap:8px;flex-wrap:wrap}'
+'.lxo-tx .q{font-family:\'JetBrains Mono\',monospace;font-size:16px;font-weight:700;color:var(--text);white-space:nowrap}'
+'.lxo-tx .c{font-size:13px;font-weight:700;color:var(--text-soft)}'
+'.lxo-side .lxq-ic{width:40px;height:40px;border-radius:50%;background:var(--lxfb,linear-gradient(135deg,#2a2a35,#1a1a23));color:#fff;font-size:13px;font-weight:800;letter-spacing:.02em;display:inline-flex;align-items:center;justify-content:center;flex:0 0 auto;box-shadow:0 0 0 1px var(--border)}'
+'.lxo-arw{width:26px;height:26px;border-radius:50%;background:var(--surface-2);border:1px solid var(--border);color:var(--text-soft);font-size:13px;display:flex;align-items:center;justify-content:center;margin:6px 0 6px 7px}'
+'.lxo-ft{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-top:13px;padding-top:12px;border-top:1px solid var(--border)}'
+'.lxo-pw{display:flex;align-items:baseline;gap:8px;min-width:0}'
+'.lxo-k{font-size:11px;font-weight:700;letter-spacing:.05em;text-transform:uppercase;color:var(--text-muted);flex:0 0 auto}'
+'.lxo-px{font-size:12.5px;color:var(--text-soft);font-family:\'JetBrains Mono\',monospace;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}'
+'.lxo-o button{flex:0 0 auto;height:32px;padding:0 14px;border-radius:9px;border:1px solid var(--border);background:transparent;color:var(--text-soft);font:inherit;font-size:12.5px;font-weight:700;cursor:pointer;transition:color .12s ease,border-color .12s ease,background .12s ease}'
...
+'var legS=qLeg("Selling",s,amt),legB=qLeg("You receive",b,amt*pr);'
+'var arw=document.createElement("span");arw.className="lxo-arw";arw.textContent="\\u2193";'
+'top.appendChild(legS);top.appendChild(arw);top.appendChild(legB);'
