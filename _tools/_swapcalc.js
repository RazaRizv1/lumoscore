...
+'.lx-swap-summary .lx-ss-ico img{display:none!important}'
...
+'function ssIco(a){if(!a)return "";var _lk=(a.code||"")+"-"+(a.iss||a.issuer||"");var lg=(a.native||a.code==="XLM")?(window.__lxStellarUri||SWSU):(a.logo||(window.__lxLogos||{})[a.code]||(window.__lxLogosI||{})[_lk]||(a.code==="LUMOS"?SWLL:""));var bg=lg?("url(\\x27"+String(lg).replace(/\\x27/g,"%27")+"\\x27)"):swCol(a.code||"?");return \'<span class="lx-ss-ico" style="--al:\'+bg+\'" data-l="\'+(lg?"":esc((a.code||"?").slice(0,1).toUpperCase()))+\'"></span>\';}'
